...
* Go to the Wordpress settings page and fill out the details. Get the 'Hotel code' from the [igumbi settings page](https://www.igumbi.net/settings/mine).
* Add to any post, page or widget. Integrate with shortcodes [igumbi_dialog] and [igumbi_avform] into your site template.
...
A: No, this plugin will help you place the igumbi online booking tool into your Wordpress site. To manage your rates, availability and reservations you use the igumbi backend.
